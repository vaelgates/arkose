...
<p>A final note: Arkose is currently in a period of potential organizational transition, such that we may be absorbed into a larger AI safety organization, or Vael may be working part-time at Arkose. We expect this position will remain as specified within this job description, and are happy to speak about this at any stage of the application process.</p> 
...
<p>The yearly pay range is $75,000 - $95,000, depending on prior experience and location. This is a remote role, but we highly prefer candidates to be able to work on roughly US time zones.</p>

<p>This is currently a 9-month-long fixed contract, until we confirm further funding and the organization's continuation.</p>

<p>This is an independent contractor role. You will not receive benefits, but will receive unlimited PTO.</p>
...
<p>If this application process will not work for you, please let us know and we may be able to find alternative ways of testing your fit.</p>

<p>Note: You can expect that the application process will be very similar to the work itself. For example, you'll be asked to draft what you might say to an example professional, you'll roleplay as a call specialist while Vael plays an ML professional, and at later stages you may talk to an ML professional.</p>
